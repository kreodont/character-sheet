...
AbilitiesTranslation = namedtuple('AbilitiesTranslation', ('strength', 'dexterity', 'constitution', 'intellect',
                                                           'wisdom', 'charisma'))
...
abilities_translation = AbilitiesTranslation(strength=Cases(именительный='сила', родительный='силы', дательный='силе',
                                             ...
                                             intellect=Cases(именительный='интеллект', родительный='интеллекта',
